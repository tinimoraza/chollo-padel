      ...
      <div style={modalStyles.modal}>
        ...
        {saved ? (
          <div style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            <div style={{ fontFamily: 'Space Grotesk, sans-serif', letterSpacing: 2, marginTop: 12, color: 'var(--accent-fg)' }}>¡FAVORITO GUARDADO!</div>
          </div>
        ) : (
          <>
...
const modalStyles: Record<string, React.CSSProperties> = {
  ...
  label: { fontSize: 11, letterSpacing: 1.5, color: 'var(--muted)', fontFamily: 'Space Grotesk, sans-serif', display: 'block' as const, marginBottom: 6 },
...
const styles: Record<string, React.CSSProperties> = {
  ...
  filterLabel: { fontFamily: 'Space Grotesk, sans-serif', fontSize: 11, letterSpacing: 2, color: 'var(--muted)' },
  filterBtn: {
  ...
  statLabel: { fontFamily: 'Space Grotesk, sans-serif', fontSize: 11, letterSpacing: 1.5, color: 'var(--muted)', marginTop: 4 },
  resultCount: { fontFamily: 'Space Grotesk, sans-serif', fontSize: 12, letterSpacing: 1.5, color: 'var(--muted)', margin: 0 },
  sortSelect: {
  ...
  conditionBadge: {
    ...
    fontSize: 10, fontFamily: 'Space Grotesk, sans-serif', letterSpacing: 1, padding: '2px 8px', borderRadius: 3,
  },
  ...
  badgeOportunidad: {
    ...
    fontFamily: 'Space Grotesk, sans-serif', borderRadius: 3,
  },
  badgePlatform: {
    position: 'absolute', bottom: 8, left: 8, background: 'rgba(0,0,0,0.75)',
    fontSize: 9, fontWeight: 600, letterSpacing: 1, padding: '3px 8px',
    fontFamily: 'Space Grotesk, sans-serif', border: '1px solid', borderRadius: 3,
  },
  btnFavorito: {
