...
interface Alerta {
  id: string; query: string; max_price: number | null
          ...
          <div key={alerta.id} style={styles.alertCard}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div>
                ...
                <div style={styles.alertName}>{alerta.query.toUpperCase()}</div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  iconBtn: { background: 'transparent', border: 'none', cursor: 'pointer', fontSize: 14, padding: 2, opacity: 0.6 },
