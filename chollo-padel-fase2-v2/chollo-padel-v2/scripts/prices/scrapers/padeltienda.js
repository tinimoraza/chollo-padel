// scripts/prices/scrapers/padeltienda.js
...
async function scrape() {
  console.log('[padeltienda] Iniciando scraper (WooCommerce Store API)…')
  ...
  while (page <= totalPages) {
    ...
    try {
      ...
      console.error(`[padeltienda] Error página ${page}:`, e.message)
      break
    }
    ...
    console.log(`[padeltienda] página ${page}/${totalPages} → ${data.length} productos`)
