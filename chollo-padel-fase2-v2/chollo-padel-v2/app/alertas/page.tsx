...
const styles: Record<string, React.CSSProperties> = {
  ...
  pageTitle: { fontFamily: 'Inter, sans-serif', fontSize: 48, letterSpacing: 4, marginBottom: 8, fontWeight: 700 },
  ...
  btnBuscar: { background: 'var(--accent)', color: '#000', border: 'none', padding: '12px 28px', fontFamily: 'Inter, sans-serif', fontSize: 14, fontWeight: 700, letterSpacing: 2, cursor: 'pointer', borderRadius: 8 },
  emptyState: { textAlign: 'center', padding: '64px 0' },
  emptyTitle: { fontFamily: 'Inter, sans-serif', fontSize: 28, letterSpacing: 3, marginBottom: 12, color: 'var(--muted)', fontWeight: 700 },
  emptyText: { color: 'var(--muted)', fontSize: 13, marginBottom: 24 },
  btnIrBuscador: { display: 'inline-block', background: 'var(--accent)', color: '#000', padding: '12px 28px', fontFamily: 'Inter, sans-serif', fontSize: 14, fontWeight: 700, letterSpacing: 2, textDecoration: 'none', borderRadius: 8 },
  section: { marginBottom: 48 },
  sectionTitle: { fontFamily: 'Inter, sans-serif', fontSize: 13, letterSpacing: 3, color: 'var(--muted)', borderBottom: '1px solid var(--border)', paddingBottom: 12, marginBottom: 20 },
  ...
  badge: { fontSize: 9, fontWeight: 700, letterSpacing: 1.5, padding: '3px 8px', fontFamily: 'Inter, sans-serif', borderRadius: 4 },
  ...
  cardQuery: { fontFamily: 'Inter, sans-serif', fontSize: 16, fontWeight: 700, letterSpacing: 1, lineHeight: 1.3, color: 'var(--text)' },
  ...
  btnBuscarAhora: { marginTop: 8, background: 'transparent', border: '1px solid rgba(61,102,0,0.3)', color: 'var(--accent-fg)', padding: '8px', fontFamily: 'Inter, sans-serif', fontSize: 11, fontWeight: 700, letterSpacing: 1.5, cursor: 'pointer', textAlign: 'center' as const, borderRadius: 6 },
  btnVerItem: { marginTop: 8, display: 'block', background: 'transparent', border: '1px solid rgba(61,102,0,0.3)', color: 'var(--accent-fg)', padding: '8px', fontFamily: 'Inter, sans-serif', fontSize: 11, fontWeight: 700, letterSpacing: 1.5, textDecoration: 'none', textAlign: 'center' as const, borderRadius: 6 },
}
