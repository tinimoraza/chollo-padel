...
const btnPrimary: React.CSSProperties = {
  ...
  padding: '11px 22px', fontFamily: 'Space Grotesk, sans-serif',
...
function CrearEquipo({ userId, onCreado }: { userId: string; onCreado: () => void }) {
  ...
  return (
    <form onSubmit={handleCrear} style={{ maxWidth: 420 }}>
      ...
      <h1 style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 26, marginBottom: 20 }}>
        Crea tu equipo
      </h1>
    ...
    <div>
      {!editandoEquipo ? (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 32 }}>
          <div>
            <h1 style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 28, marginBottom: 4 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, borderTop: '1px solid var(--border)', paddingTop: 28 }}>
        <h2 style={{ fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 18, letterSpacing: 0.5 }}>
