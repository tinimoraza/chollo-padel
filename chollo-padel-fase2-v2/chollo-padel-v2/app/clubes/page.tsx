...
export default function ClubesLandingPage() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', fontFamily: 'Barlow, sans-serif' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '80px 24px 64px' }}>
        ...
        <p style={{
          ...
          fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, marginBottom: 12,
        }}>
        ...
        <p style={{ fontSize: 17, lineHeight: 1.6, color: 'var(--muted)', marginBottom: 36, maxWidth: 560 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 40px', display: 'grid', gap: 12 }}>
          {[
            ...
            <li key={item} style={{ display: 'flex', gap: 10, alignItems: 'flex-start', fontSize: 14.5, color: 'var(--text)' }}>
        ...
        <p style={{ color: 'var(--faint)', fontSize: 11, marginTop: 40 }}>
